...
map<string, long long> patternCount;
map<string, long long> designPossible;
...
long long canMakeDesign(string &design)
{
    long long ans = 0;
...
void solve()
{
    ...
    long long total_possibleDesigns = 0;
    for (auto &design : wanted_designs)
    {
        long long can = canMakeDesign(design);
